...
**[MCP Chain of Draft Prompt Tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)**
Open-source Model Context Protocol server giving agents one scoped interface to tools and
context instead of per-integration glue. Adopted by 30+ engineers, driven through
...
I take AI systems from prototype to production: multi-agent architecture, tool and
permission design, retrieval that holds up under real data, evaluation pipelines that catch
regressions before users do, and fine-tuning when a local model beats an API call.
...
[brendancopley.com](https://brendancopley.com) · [LinkedIn](https://www.linkedin.com/in/brendancopley)
